                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          child: Card(
                            ...
                            child: Container(
                              decoration:
                              BoxDecoration(borderRadius: BorderRadius.circular(15), color: Color(0xfff8f8f8)),
                              child: Padding(
                                padding: EdgeInsets.symmetric(horizontal: 15, vertical: 12),
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.pushReplacement(
                              context, MaterialPageRoute(builder: (context) => LostItemsScreen(userID: widget.userID)));
                        },
                        child: Container(
                          height: 100,
                          child: Card(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.pushReplacement(context,
                              MaterialPageRoute(builder: (context) => FoundItemsScreen(userID: widget.userID)));
                        },
                        child: Container(
                          height: 100,
                          child: Card(
                  ...
                  children: [
                    Expanded(
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.pushReplacement(
                              context, MaterialPageRoute(builder: (context) => userProfilePage(userID: widget.userID)));
                        },
                        child: Container(
                          height: 100,
                          child: Card(
